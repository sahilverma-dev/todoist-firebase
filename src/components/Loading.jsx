...
import { TodoistSquareRedIcon } from "./Icons";

const Loading = () => {
  return (
    <div className="min-h-screen w-screen bg-gray-200 dark:bg-black/90 flex items-center justify-center">
      <div className="flex flex-col gap-6 items-center">
        <TodoistSquareRedIcon />
        <svg
